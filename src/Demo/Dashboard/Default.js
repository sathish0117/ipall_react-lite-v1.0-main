            ...
            <Aux>
                <Row>
                    <Col md={4} xl={4}>
                        <Card>
                            <Card.Body>
                                <h6 className='mb-4 f-30 m-r-5'>Collection</h6>
                                <div className="row d-flex align-items-center">
                                    <div className="col-9">
                                        <h3 className="f-w-300 d-flex align-items-center m-b-0"><i className="feather icon-arrow-up text-c-red f-30 m-r-5"/> </h3>
                                    </div>

                                    <div className="col-3 text-right">
                                        <i className='feather icon-droplet f-30'/>
                                        <h5>Ltr</h5>
                                    </div>
                                </div>
                    ...
                    <Col md={4} xl={4}>
                        <Card>
                            <Card.Body>
                                <h6 className='mb-4 f-30 m-r-5'>Sales</h6>
                                <div className="row d-flex align-items-center">
                                    <div className="col-9">
                                        <h3 className="f-w-300 d-flex align-items-center m-b-0"><i className="feather icon-arrow-down text-c-red f-30 m-r-5"/> </h3>
                                    </div>
                    ...
                    <Col md={4} xl={4}>
                        <Card>
                            <Card.Body>
                                <h6 className='mb-4 f-30 m-r-5'>Remaining</h6>
                                <div className="row d-flex align-items-center">
                                    <div className="col-9">
                                        <h3 className="f-w-300 d-flex align-items-center m-b-0"><i className="feather icon-arrow-up text-c-red f-30 m-r-5"/> </h3>
                                    </div>
                    ...
                    <Col md={4} xl={4}>
                        <Card>
                            <Card.Body>
                                <h6 className='mb-4 text-c-blue f-30 m-r-5'>Collection</h6>
                                <div className="row d-flex align-items-center">
                                    <div className="col-9">
                                    ...
                                    <div className="col-3 text-right">
                                        <p className="m-b-0 f-30 m-r-5">₹</p>
                                    </div>
                                </div>
                                {/* <div className="progress m-t-30" style={{height: '7px'}}>
                                    <div className="progress-bar progress-c-theme" role="progressbar" style={{width: '50%'}} aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"/>
                    ...
                    <Col md={4} xl={4}>
                        <Card>
                            <Card.Body>
                                <h6 className='mb-4 text-c-blue f-30 m-r-5'>Sales</h6>
                                <div className="row d-flex align-items-center">
                                    <div className="col-9">
                                        <h3 className="f-w-300 d-flex align-items-center m-b-0"><i className="feather icon-arrow-up text-c-green f-30 m-r-5"/> </h3>
                                    </div>
                    ...
                    <Col md={4} xl={4}>
                        <Card>
                            <Card.Body>
                                <h6 className='mb-4 text-c-blue f-30 m-r-5'>Profit</h6>
                                <div className="row d-flex align-items-center">
                                    <div className="col-9">
                                        <h3 className="f-w-300 d-flex align-items-center m-b-0"><i className="feather icon-arrow-up text-c-green f-30 m-r-5"/> </h3>
                                    </div>
