            ...
            <Aux>
                <Row>
                    ...
                    <Col md={6} xl={6}>
                        <Card>
                            <Card.Body>
                                <h6 className='mb-4'>Total purchase</h6>
                                <div className="row d-flex align-items-center">
                                    <div className="col-9">
                                        <h3 className="f-w-300 d-flex align-items-center m-b-0"><i className="feather icon-arrow-up text-c-green f-30 m-r-5"/> Ltr</h3>
                                    </div>
                    ...
                    <Col md={6} xl={6}>
                        <Card>
                            <Card.Body>
                                <h6 className='mb-4'>Daily Expenses</h6>
                                <div className="row d-flex align-items-center">
                                    <div className="col-9">
